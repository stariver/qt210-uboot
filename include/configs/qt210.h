...
#define CONFIG_QT210		1
//#define CONFIG_SILVER210		1
#define CONFIG_QT210_I2C		1
...
//#define CONFIG_BOOTARGS    	"root=ramfs devfs=mount console=ttySAC1,115200 ubi.mtd=4 ubi.mtd=5 no_console_suspend"
#define CONFIG_NAND_BOOTARGS    "root=ramfs devfs=mount console=ttySAC0,115200 ubi.mtd=4 ubi.mtd=5 ubi.mtd=6"
#define CONFIG_NAND_BOOTCMD    "nand read 20008000 600000 500000;nand read 21000000 B00000 300000;bootm 20008000 21000000"
//#define CONFIG_MMC_BOOTCMD    "movi read kernel 20008000;bootm 20008000"
//#define CONFIG_MMC_BOOTARGS    	"root=/dev/mmcblk0p3 rootfstype=ext3 console=ttySAC1,115200"
#define CONFIG_MMC_BOOTCMD    "movi read kernel 20008000; movi read rootfs 21000000 300000;bootm 20008000 21000000"
#define CONFIG_MMC_BOOTARGS    	"console=ttySAC0,115200"
...
#define CFG_PROMPT              "QT210 # "   /* Monitor Command Prompt       */
...
/*
 * QT210 board specific data
 */

#define CONFIG_IDENT_STRING	" for QT210"
...
//#define MTDPARTS_DEFAULT	"mtdparts=s5pv210-nand:1m(bootloader),5m(recovery),5m(kernel),3m(ramdisk),128m(system),114m(userdata)"
#define MTDPARTS_DEFAULT	"mtdparts=s5pv210-nand:1m(bootloader),5m(recovery),5m(kernel),3m(ramdisk),180m(system),16m(cache),302m(userdata)"
#define MTD_PARTITION	"nand0,0"
#define CONFIG_MTDPARTITION	"80000 400000 3000000"
#define MTD_DEVNAME	"bootloader"
#define CONFIG_NAND
