...
#		cp -f u-boot.bin /share/image/qt210_uboot.bin
...
qt210_config :	unconfig
	@$(MKCONFIG) $(@:_config=) arm s5pc11x qt210 samsung s5pc110
	@echo "TEXT_BASE = 0x2fd00000" > $(obj)board/samsung/qt210/config.mk
