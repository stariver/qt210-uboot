...
static inline u32 smc911x_eth_reg_read(struct eth_device *dev, u32 offset)
{
	volatile u16 *addr_16 = (u16 *)(dev->iobase + offset);
	return ((*addr_16 & 0x0000ffff) | (*(addr_16 + 1) << 16));
}
static inline void smc911x_eth_reg_write(struct eth_device *dev,	u32 offset, u32 val)
{
