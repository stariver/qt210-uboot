...
fastboot_ptentry ptable_default[] =
{
	...
	},
	{
		.name     = "system",
		.start    = 0xE00000,
//		.length   = 0x8000000,	// 128M HCJ.
		.length   = 0xB400000,	// 180M HCJ.		
...
#if defined(CONFIG_QT210)	// Not use cache area
//hcj: added cache area
    {
		.name     = "cache",
		.start    = 0xC200000,
	...
	{
		.name     = "userdata",
//		.start    = 0x8E00000, // HCJ   114M
		.start    = 0xD200000, // HCJ     90M		
