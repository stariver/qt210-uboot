...
//	printf("GetI2CSDA()\n");
	...
	val = readl(ELFIN_GPIO_BASE+GPD1DAT_OFFSET);
...
//	printf("SetI2CSCL()\n");
	...
	val &= ~(1<<14);
	val |= (x&0x00000001)<<14;
	writel(val, ELFIN_GPIO_BASE+GPD1DAT_OFFSET);
#endif
}
...
{
	S5PC11X_I2C *const i2c = S5PC11X_GetBase_I2C ();
	int i, status;
...
{
	S5PC11X_I2C * const i2c = (S5PC11X_I2C *)ELFIN_I2C_BASE;
...
//	printf("i2c_init()\n");
	...
	writel(0xa0000000, ELFIN_GPIO_BASE+GPD1CON_OFFSET);
#endif
...
#endif /* CONFIG_DRIVER_S5PC11X_I2C */
